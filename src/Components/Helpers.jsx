...
{
  let url = 'https://sircode.somee.com/api/QuestionLevel?IdDependency=1';
  let response;
  let data = [];
  let tempdata = [];
  try 
...
{
  let url = 'https://sircode.somee.com/api/FinalTestMessage?IdDependency=1';
  let response;
  let data = [];
  let tempdata = [];
  try 
...
{
  let url = 'https://sircode.somee.com/api/Setting?IdDependency=1';
  let response;
  let data = [];
  let tempdata = [];
  try 
...
{
  let url = 'https://sircode.somee.com/api/Question?IdDependency=1&CodLevel='+ codlevel;
  let response;
  let data = [];
  let tempdata = [];
  try {
